...
@section('header_title', 'HR Specialist Profile')
...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div>
        ...
        <p class="mt-0.5 text-xs text-[#6B6B6B] dark:text-[#A1A1A1]">
            Manage your account credentials and review assigned HR employee information.
        </p>
    </div>
    ...
    <div class="grid gap-6 md:grid-cols-12">
        ...
        <div class="md:col-span-4 rounded-2xl border border-[#E5E5E5] bg-white p-6 dark:border-[#262626] dark:bg-[#141414] shadow-xs text-center space-y-4">
            <div class="mx-auto flex h-20 w-20 items-center justify-center rounded-2xl bg-purple-500/10 text-3xl font-extrabold text-purple-600 dark:text-purple-400 border border-purple-500/20">
            ...
            <div>
                ...
                <span class="mt-2 inline-flex rounded-full bg-purple-600 px-3 py-0.5 text-[10px] font-bold uppercase text-white shadow-xs">
                    HR Recruiter
                </span>
            </div>
            ...
            @if($user->employee)
                <div class="pt-4 border-t border-[#E5E5E5] dark:border-[#262626] text-xs text-left space-y-2 text-[#6B6B6B] dark:text-[#A1A1A1]">
                    <div class="flex justify-between">
                        ...
                        <span class="font-bold text-purple-600 font-mono">{{ $user->employee->employee_code }}</span>
                    </div>
                    <div class="flex justify-between">
        ...
        <div class="md:col-span-8 rounded-2xl border border-[#E5E5E5] bg-white p-6 sm:p-8 dark:border-[#262626] dark:bg-[#141414] shadow-xs">
            ...
            <form action="{{ route('hr.profile.update') }}" method="POST" class="mt-5 space-y-4">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    <input
                        ...
                        required
                        class="mt-1.5 w-full rounded-xl border border-[#E5E5E5] bg-[#F7F7F7] px-4 py-2.5 text-xs text-[#111111] outline-none transition focus:border-purple-600 focus:bg-white dark:border-[#262626] dark:bg-[#1A1A1A] dark:text-white"
                    >
                    @error('name')
